...
import { acceptFriendRequest, getAllNotification, getMyProfile, login, logout, newUser, searchUser, sendFriendRequest } from "../controllers/user.js";
...
app.get("/friends",getAllNotification)
